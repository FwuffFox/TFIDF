...
class TestDocumentController:
    ...
    def mock_storage(self, monkeypatch):
        ...
        monkeypatch.setattr("app.utils.storage.FileStorage.save_bytes_by_path", save_mock)
        ...
        monkeypatch.setattr("app.utils.storage.FileStorage.delete_file_by_path", delete_mock)
    ...
    async def test_create_duplicate_document(self, client, user_data):
        ...
        response = await upload_document(client, token, "Duplicate Document", "Same content")
    ...
    async def test_get_document(self, client, user_data):
        ...
        # Upload document
        upload_response = await upload_document(client, token, "Download Test", "Document content for download")
    ...
    async def test_get_statistics_unauthorized_document(self, client, user_data, alt_user_data):
